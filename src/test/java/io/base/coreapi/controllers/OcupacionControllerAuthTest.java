...
@Slf4j
@DisplayName("OcupacionControllerAuthTest.")
public class OcupacionControllerAuthTest extends CrudAbstract {
    ...
    public void extraSetupSteps() {
        this.baseUrl="/api/v1/ocupacion/";
        this.bodyForUpdate.put("activo", "false");
        this.bodyForUpdate.put("nombre", "Update ocupacion 223Q4SDAF"+ UUID.randomUUID().toString().replace("-", ""));
        bodyForCreate.put("activo", "true");
        bodyForCreate.put("nombre", "ocupacion 223Q4SDAF"+ UUID.randomUUID().toString().replace("-", ""));
