...
@Slf4j
@DisplayName("GeneroControllerTest.")
public class GeneroControllerTest extends CrudAbstract {
    ...
    public void extraSetupSteps() {
        this.baseUrl="/api/v1/genero/";
        this.bodyForUpdate.put("activo", "false");
        this.bodyForUpdate.put("nombre", "female "+ UUID.randomUUID().toString().replace("-", ""));
        bodyForCreate.put("activo", "true");
        bodyForCreate.put("nombre", "male "+ UUID.randomUUID().toString().replace("-", ""));
