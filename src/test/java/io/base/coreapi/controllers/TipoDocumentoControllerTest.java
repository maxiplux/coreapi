...
@Slf4j
@DisplayName("TipoDocumentoControllerTest.")
public class TipoDocumentoControllerTest extends CrudAbstract {
    ...
    public void extraSetupSteps() {
        this.baseUrl="/api/v1/tipo-de-documento/";
        ...
        bodyForCreate.put("nombre", "COLOMBINO 223Q4SDAF"+ UUID.randomUUID().toString().replace("-", ""));
