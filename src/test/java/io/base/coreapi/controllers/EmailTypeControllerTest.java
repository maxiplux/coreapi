...
@Slf4j
@DisplayName("EmailTypeControllerTest.")
public class EmailTypeControllerTest extends CrudAbstract {
    ...
    public void extraSetupSteps() {
        this.baseUrl="/api/v1/email-type/";

        this.bodyForUpdate.put("nombre", "email-type   223Q4SDAF"+ UUID.randomUUID().toString().replace("-", ""));

        bodyForCreate.put("nombre", "email-type 223Q4SDAF"+ UUID.randomUUID().toString().replace("-", ""));
