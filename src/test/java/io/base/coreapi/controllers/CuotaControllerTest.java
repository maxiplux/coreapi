...
@Slf4j
@DisplayName("CuotaControllerTest.")
public class CuotaControllerTest extends CrudAbstract {
    ...
    public void extraSetupSteps() {
        this.baseUrl="/api/v1/cuota/";
        bodyForUpdate.put("valor", "100.0");
        this.bodyForUpdate.put("nombre", "Update COLOMBINO 223Q4SDAF"+ UUID.randomUUID().toString().replace("-", ""));
        bodyForCreate.put("valor", "100.0");
        bodyForCreate.put("nombre", "cuota 223Q4SDAF"+ UUID.randomUUID().toString().replace("-", ""));
